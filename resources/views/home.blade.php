...
@section('content')
    ...
    <section class="container -card">
        ...
        <div class="grid padding-side-lg">
            <a href="{{route('shop.index',['category'=>'new-arrivals'])}}" class="card">
                <div class="cover-img">
            ...
            <a href="{{route('shop.index',['category'=>'trending-now'])}}" class="card">
                <div class="cover-img">
            ...
            <a href="{{route('shop.index',['category'=>'special-offers'])}}" class="card">
                <div class="cover-img">
            ...
            <a href="{{route('shop.index',['category'=>'editors-choice'])}}" class="card">
                <div class="cover-img">
            ...
            <a href="{{route('shop.index',['category'=>'living-room'])}}" class="card">
                <div class="cover-img">
            ...
            <a href="{{route('shop.index',['category'=>'bedroom'])}}" class="card">
                <div class="cover-img">
            ...
            <a href="{{route('shop.index',['category'=>'kitchen'])}}" class="card">
                <div class="cover-img">
            ...
            <a href="{{route('shop.index',['category'=>'bathroom'])}}" class="card">
                <div class="cover-img">
